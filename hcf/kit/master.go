...
func (Master) Armour(*player.Player) [4]item.Stack {
	...
	return [4]item.Stack{
		...
		item.NewStack(item.Leggings{Tier: item.ArmourTierDiamond{}}, 1).WithEnchantments(protection, unbreaking).WithCustomName(text.Colourf("§r<purple>Master Leggings</purple>")),
